<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverReg.aspx.cs" Inherits="GoKid.DriverReg" %>
...
<body>
    <div class="registration-container">
        ...
        <form method="post" action="DriverReg.aspx" onsubmit="return handleRegistration(event)">
            ...
            <input type="text" name="vehicle_reg_no" placeholder="Vehicle Registration Number" required>
